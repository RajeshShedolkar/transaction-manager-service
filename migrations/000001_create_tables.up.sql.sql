...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    saga_status VARCHAR(50) DEFAULT 'NOT_STARTED',  -- NOT_STARTED, IN_PROGRESS, COMPLETED, FAILED
    status VARCHAR(50) NOT NULL,             -- INITIATED, PENDING, AUTHORIZED, COMPLETED, RELEASED, FAILED
